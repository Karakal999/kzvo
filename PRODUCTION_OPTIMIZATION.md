...
Цей документ описує всі оптимізації, впроваджені для підготовки сайту до продакшену.
...
## 🔧 Налаштування Vite для Продакшену
...
export default defineConfig({
  ...
  build: {
    ...
    sourcemap: false, // або 'hidden' для продакшену
  },
});
```
